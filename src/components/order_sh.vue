<template>
	<div>
		...
		<div class="nav">
			<router-link to="/order">全部</router-link>
			<router-link to="/order_dfk">待付款</router-link>
			<router-link to="/order_dfh">待发货</router-link>
			<router-link to="/order_dsh">待收货</router-link>
			<a href="javascript:void(0)" class="selected">售后</a>
		</div>
		<div class="main">
			<div class="m_goods">
				<div class="m_g_t">
					<p class="g_time">2018-06-01 09:01:00</p>
					<p class="g_status">售后中</p>
				</div>
				<div class="m_g_i" @click="on_show_info">
				...
				<p class="m_g_p"><span>共1件商品 合计：</span>¥999</p>
			</div>
			<div class="m_goods">
				<div class="m_g_t">
					<p class="g_time">2018-06-01 09:01:00</p>
					<p class="g_status">退款中</p>
				</div>
				<div class="m_g_i" @click="on_show_info">
					<img src="../assets/images/g0.png">
					<div class="g_i_i">
